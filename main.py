...
janela.geometry("235x310")  # primeiro é a largura e depois a altura
janela.config(bg=cor1)

# criando os frames/telas
...
b_2.place(x=118, y=0)
b_3 = Button(frame_corpo, command=lambda: colocar_valores('/'), text="/", width=5, height=2, bg=cor6, fg=cor2, font=('Ivy 13 bold'), relief=RAISED,
             overrelief=RIDGE)
b_3.place(x=177, y=0)
...
b_11 = Button(frame_corpo, command=lambda: colocar_valores('*'),text="*", width=5, height=2, bg=cor6, fg=cor2, font=('Ivy 13 bold'), relief=RAISED,
              overrelief=RIDGE)
...
b_15 = Button(frame_corpo, command=lambda: colocar_valores('-'),text="-", width=5, height=2, bg=cor6, fg=cor2, font=('Ivy 13 bold'), relief=RAISED,
              overrelief=RIDGE)
...
b_19 = Button(frame_corpo, command=lambda: colocar_valores('+'),text="+", width=5, height=2, bg=cor6, fg=cor2, font=('Ivy 13 bold'), relief=RAISED,
              overrelief=RIDGE)
...
b_22 = Button(frame_corpo, command=calcular,text="=", width=5, height=2, bg=cor6, fg=cor2, font=('Ivy 13 bold'), relief=RAISED,
              overrelief=RIDGE)
